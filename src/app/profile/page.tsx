    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between">
            <div className="flex flex-col min-h-dvh">
                ...
                <main className="py-12 md:py-24 lg:py-24">
                    <section>
                        <h1 className={"text-center font-bold text-5xl mb-16"}>Profile</h1>
                        <ProfileCard username={data?.username} email={data?.email}/>
                    </section>
                    <section className="bg-muted py-12 md:py-24 lg:py-32">
                        <div className="container grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-16 md:px-6">
                            <div className="flex flex-col items-start space-y-4">
                                <h2 className="text-3xl font-bold text-foreground sm:text-4xl md:text-5xl">What about
                                    paying less for the same quality ?</h2>
                            ...
                            <div className="flex justify-center">
                                <img
                                    src="https://images.unsplash.com/photo-1513442542250-854d436a73f2?q=80&w=2147&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    width={500}
                                    height={400}
                ...
                <footer className="bg-background border-t">
                    <div
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-sm text-muted-foreground">&copy; 2024 Table Goat. All rights
                                reserved.</p>
                        </div>

        ...
        <main className="flex min-h-screen flex-col items-center justify-between">
            <div className="flex flex-col min-h-dvh">
                ...
                <main className="py-12 md:py-24 lg:py-24">
                    <section>
                        <h1 className={"text-center font-bold text-5xl mb-16"}>Contact us</h1>
                        <ContactForm/>
                    </section>
                    <section className="bg-muted py-12 md:py-24 lg:py-32">
                        <div className="container grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-16 md:px-6">
                            ...
                            <div className="flex justify-center">
                                <img
                                    src="https://images.unsplash.com/photo-1575037614876-c38a4d44f5b8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    width={500}
                                    height={400}
